...
public class VytrackTestBase {
    ...
    protected CreateCalendarEventPage calendarEventPage;
    //private because I will only use it in this class
    protected ExtentReports report;
    private ExtentHtmlReporter htmlReporter;
    //create a actual test and log the steps inside it
    ...
    public void setUpMethod() {
        ...
        calendarEventPage = new CreateCalendarEventPage();
    }

    @AfterMethod
    public void tearDownMethod(ITestResult iTestResult) throws InterruptedException, IOException {
        //ITestResult --> gives info about current test: name, status
        //check if the test failed
        if (iTestResult.getStatus()==ITestResult.FAILURE){
            //tell extentReport that the test failed
